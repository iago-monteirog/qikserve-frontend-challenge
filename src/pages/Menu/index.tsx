...
import { CloseButton, Content, DialogContent, DialogOverlay, MenuBox, MenuContainer, MobileCartButton, ShopCartContainer } from './styles'
...
export const Menu = () => {
  ...
  const mobileCartButtonText = items.length > 1 ?
