...
import { CustomerThemeType, createCustomerTheme, defaultCustomerTheme } from "../styles/themes/customerTheme";
...
const ThemeContextProviderComponent = ({ children }: ThemeContextProviderProps) => {
